...
You can save, remove, and reorder snapshots directly on the Dwarf, without opening the Web UI:
...
As with the Web UI, **re-save the pedalboard** after any of these changes so they stick.

---

Next: [Playing Live](../playing-live/concepts-modes.md)
