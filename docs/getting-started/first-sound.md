...
1. Press footswitches B and C together to enter **Navigation Mode**.
2. Use the left-most encoder, or footswitches B/C, to scroll the list and load a different pedalboard.

See [Playing Live](../playing-live/concepts-modes.md) for the full rundown of Control Mode, Navigation Mode, and Tool Mode, or jump to [Your First Pedalboard](../first-pedalboard/web-ui-access.md) to start building your own.
